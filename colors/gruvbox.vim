...
" vim: set sw=2 ts=2 sts=2 et tw=80 ft=vim fdm=marker:
" bg #32302f
hi! DiffAdd guibg=#4E4C29 guifg=NONE cterm=NONE gui=NONE ctermfg=NONE ctermbg=236
hi! DiffDelete guibg=#5C2D2A guifg=NONE cterm=NONE gui=NONE ctermfg=NONE ctermbg=236
hi! DiffChange guibg=#414E3F guifg=NONE cterm=NONE gui=NONE ctermfg=NONE ctermbg=236
